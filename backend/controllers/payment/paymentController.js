...
// const striptModel = require('../../models/stripeModel');
// // const sellerWallet = require('../../models/sellerWallet');
// const myShopWallet = require('../../models/myShopWallet'); // Check if this is used, it's imported but not used in the provided code.
// // const withdrowRequest = require('../../models/withdrowRequest');
// // const { responseReturn } = require('../../utiles/response');
...
// class paymentController {
//     constructor() {
//         this.merchant_id = 'DOOLKYONLINE';
//         this.salt_key = '38dcc62f-f9cc-4d58-8843-d13262025e21';
//     }

//     create_stripe_connect_account(req, res) {
//         try {
...
//                 merchantUserId: MUID,
//                 name,
//                 amount: amount * 100, // Assuming amount is in rupees; adjust if needed
...
//             const keyIndex = 1;
//             const string = payloadMain + '/pg/v1/pay' + this.salt_key;
...
//                 console.error(error);
//                 responseReturn(res, 500, { message: 'Error in PhonePe payment initiation', success: false });
//             });

//         } catch (error) {
//             console.error(error);
//             responseReturn(res, 500, { message: 'Internal server error', success: false });
//         }
//     }
