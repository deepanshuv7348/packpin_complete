        ...
        <div className='px-2 md:px-7 py-5'>
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7'>
                <div className='flex justify-between items-center p-5 bg-[#fff] rounded-md gap-3'>
                    ...
                    <div className='w-[46px] h-[47px] rounded-full bg-[#0a532b1f] flex justify-center items-center text-xl'>
                ...
                <div className='flex justify-between items-center p-5 bg-[#fff] rounded-md gap-3'>
                    ...
                    <div className='w-[46px] h-[47px] rounded-full bg-[#3f32d31f] flex justify-center items-center text-xl'>
            ...
            <div className='w-full flex flex-wrap mt-7'>
                <div className='w-full lg:w-7/12 lg:pr-3'>
                    <div className='w-full bg-[#fff] p-4 rounded-md'>
                        <Chart className="text-[#000000]" options={state.options} series={state.series} type='bar' height={350} />
                    </div>
                </div>
                <div className='w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
                    <div className='w-full bg-[#fff] p-4 rounded-md text-[#000000]'>
            ...
            <div className='w-full p-4  bg-[#fff] rounded-md mt-6'>
                <div className='flex justify-between items-center'>
                    ...
                    <Link to='/seller/dashboard/orders' className='font-semibold text-sm text-[#00000]'>View All</Link>
                </div>
