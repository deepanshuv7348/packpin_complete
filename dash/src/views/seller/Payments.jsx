        ...
        <div className='px-2 md:px-7 py-5'>
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-5'>
                <div className='flex justify-between items-center p-5 bg-[#fff] rounded-md gap-3'>
                    <div className='flex flex-col justify-start items-start text-[#00000]'>
                        <h2 className='text-lg font-bold'>${totalAmount}</h2>
                        <span className='text-sm font-normal'>Total Sales</span>
                    </div>
                    <div className='w-[46px] h-[47px] rounded-full bg-[#05180d1f] flex justify-center items-center text-xl'>
            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-3 pb-4'>
                <div className='bg-[#fff]  text-[#000000] rounded-md p-5'>
                    <h2 className='text-lg'>Send withdrawal Request</h2>
                    <div className='py-5'>
                        <form onSubmit={sendRequest}>
                            <div className='flex gap-3 flex-wrap'>
                                <input onChange={(e) => setAmount(e.target.value)} required value={amount} min='0' type="number" className='px-3 md:w-[79%] py-2 focus:border-indigo-500 outline-none  bg-[#d5d5da] text-[#000000]  border border-slate-700 rounded-md' name='amount' />
                                <button disabled={loader} className='bg-red-500 hover:shadow-red-500/50 hover:shadow-lg text-white rounded-sm px-4 py-2 text-sm '>{loader ? 'loading..' : 'Submit'}</button>
                            </div>
                        </form>
                    </div>
                    <div>
                        ...
                        <div className='w-full overflow-x-auto'>
                            <div className='flex bg-[#d5d5da] text-[#000000] uppercase text-xs min-w-[340px]'>
