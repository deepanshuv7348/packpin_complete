                ...
                <div className='flex w-full h-full relative'>
                    ...
                    <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
                            ...
                            <div className=' bg-slate-300 h-[calc(100vh-290px)] rounded-md p-3 overflow-y-auto'>
                                {
                                            ...
                                            return (
                                                <div ref={scrollRef} key={i} className='w-full flex justify-start items-center'>
                                                    <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                                                        ...
                                                        <div className='flex justify-center items-start flex-col w-full bg-orange-500 shadow-lg shadow-orange-500/50 text-black py-1 px-2 rounded-sm'>
                                                            <span>{m.message}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    }) : <div className='w-full h-full bg-slate-300 flex justify-center items-center flex-col gap-2 text-black'>
                        ...
                        <form onSubmit={send} className='flex gap-3'>
                            ...
                            <button disabled={customerId ? false : true} className='shadow-lg bg-red-500 hover:shadow-cyan-500/50 text-semibold w-[75px] h-[35px] rounded-md text-white flex justify-center items-center'>Send</button>
                        </form>
                    </div>
                </div>
            </div>
