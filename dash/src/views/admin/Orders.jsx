        ...
        <div className='px-2 lg:px-7 pt-5'>
            <div className='w-full p-4  bg-[#fff] rounded-md'>
                <div className='flex justify-between items-center'>
                    <select onChange={(e) => setParPage(parseInt(e.target.value))} className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#d5d5da]  text-[#000000] border border-slate-700 rounded-md text-[#d0d2d6]'>
                        <option value="5">5</option>
                        <option value="5">15</option>
                        <option value="5">25</option>
                    </select>
                    <input className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#d5d5da] border border-slate-700 rounded-md text-[#d0d2d6]' type="text" placeholder='search' />
                </div>
                    ...
                    <div className='w-full text-sm text-left [#d0d2d6]'>
                        ...
                        </div>
                        {
                            myOrders.map((o, i) => <div className='text-[#000000]'>
                                ...
                                <div className={show === o._id ? 'block border-b border-slate-700 bg-white' : 'hidden'}>
                                    {
