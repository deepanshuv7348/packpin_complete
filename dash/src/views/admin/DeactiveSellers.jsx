        ...
        <div className='px-2 lg:px-7 pt-5'>
            <div className='w-full p-4  bg-[#fff] rounded-md'>
                <div className='flex justify-between items-center'>
                    <select onChange={(e) => setParPage(parseInt(e.target.value))} className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#d5d5da] border border-slate-700 rounded-md text-[#000000]'>
                        <option value="5">5</option>
                        <option value="5">15</option>
                        <option value="5">25</option>
                    </select>
                    <input onChange={e => setSearchValue(e.target.value)} value={searchValue} className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#d5d5da] border border-slate-700 rounded-md text-[#000000]' type="text" placeholder='search' />
                </div>
