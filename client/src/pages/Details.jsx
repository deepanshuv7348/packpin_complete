                ...
                <div className=' w-[85%] xs:w-[95%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto pb-16'>
                    <div className='grid grid-cols-2 md-lg:grid-cols-1   gap-8'>
                        <div className='flex flex-col justify-start items-center'>
                            <div className='p-5 xs:p-0 border items-center w-[100%]'>
                                <img src={image ? image : product.images?.[0]} className='w-[100%]' alt="" />
                            </div>
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='flex flex-col py-5 gap-3'>
                                <div className='flex gap-3 flex-col'>
                                    ...
                                    <div className=' flex gap-1 flex-grow'>
                                        <div className=' space-x-4 px-2 text-[15px] w- py-2 h-[40px] cursor-pointer hover:text-white hover:bg-red-500 hover:shadow-lg hover:shadow-red-500/40 rounded-2xl bg-white-500 text-black border-solid border-2 border-red-500'>
                                            <label>8.5 x 4.5 x 3.5</label>
                                            <input type="checkbox"/>
                                        </div>
                                        <div className=' space-x-4 px-2 text-[15px] w- py-2 h-[40px] cursor-pointer hover:text-white hover:bg-red-500 hover:shadow-lg hover:shadow-red-500/40 rounded-2xl bg-white-500 text-black border-solid border-2 border-red-500'>
                                            <label>8.5 x 4.5 x 3.5</label>
                                ...
                                <div className='flex flex-col  gap-3 '>
                                    ...
                                    {
                                        product.stock ? <>
                                            <div className='flex bg-slate-200 w-[170px] h-[50px] rounded-xl justify-center items-center text-xl border-solid border-2 border-red-500'>
                            ...
                            <div className='flex xs:flex-col gap-3 w-full'>
                                ...
                                {
                                    product.stock ? <button onClick={add_card} className='w-[350px] py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-purple-500/40 bg-red-500 rounded-full font-bold text-white'>Add To Card</button> : ""
                                }
                            </div>
                        </div>
                    </div>
